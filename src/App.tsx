...
import { checkNotificationPermission, scheduleNotification } from './api';
...
function App() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    scheduleNotification(newTask.id, newTask.description, scheduledAt);
    setTasks((prevTasks) => {
  ...
  async function resolveTask(taskId: number) {
    ...
    invoke('cancel_notification', { id: taskId.toString() });
  }
